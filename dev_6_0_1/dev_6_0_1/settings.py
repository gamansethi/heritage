"""
Django settings for dev_6_0_1 project.
"""
...
DATATYPE_LOCATIONS.append('dev_6_0_1.datatypes')
FUNCTION_LOCATIONS.append('dev_6_0_1.functions')
SEARCH_COMPONENT_LOCATIONS.append('dev_6_0_1.search_components')
...
SECRET_KEY = 'by)484jzi#napc^u2fi&yw@50c#0wj8vc3s4fagdh=6vu8&960'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'dev_6_0_1.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'dev_6_0_1'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'dev_6_0_1.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'dev_6_0_1.wsgi.application'
